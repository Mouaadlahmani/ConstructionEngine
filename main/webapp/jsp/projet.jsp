...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
      ...
      <div class="btn"><a type="button" href="ajouter" class="btn btn-warning">Ajouter un Project</a></div>
      <div class="container">
          ...
          <div class="card shadow-lg p-3 mb-5 bg-light rounded" style="width: 18rem;">
              <div class="card-body">
                  <h5 class="card-title"><%= projet.getNom() %>
                  </h5>
                  ...
                  <a type="button" class="btn btn-success mt-1" href="jsp/modifier.jsp"
                  onclick="href="modifier?id=<%= projet.getProjet_id()%>">
                  ...
                  <a type="button" class="btn btn-danger mt-1"
                     onclick="confirm ('Confirmer')" href="suprimer?id=<%= projet.getProjet_id()%>"
                  >
